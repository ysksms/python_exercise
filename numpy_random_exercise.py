...
print("* Maximum value: ", random_array_1d.max())
print("* Minimum value: ", random_array_1d.min())
print()
...
print("Sum of all elements: ", random_array_2d.sum())
print()
...
print("* Array B")
print(array_b)
print("* Addition of A and B: ", array_a + array_b)
print("Subtraction of A and B: ", array_a - array_b)
print("Multiplication of A and B: ", array_a * array_b)
print()
